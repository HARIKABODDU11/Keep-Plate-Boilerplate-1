...
retrieved notes object
	...
	public ModelAndView addNote(@RequestParam Integer noteId, @RequestParam String noteTitle, @RequestParam String noteContent, @RequestParam String noteStatus) {

		ModelAndView model = new ModelAndView();
		if(noteTitle.isEmpty()||noteContent.isEmpty()||noteStatus.isEmpty()||noteId==null)
		{
			model.addObject("error","Please fill the required fields");}
